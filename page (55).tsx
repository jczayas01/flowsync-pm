...
const inviteSchema = z.object({
  ...
  role:      z.enum(["ADMIN","SUPER_USER","PROGRAM_MANAGER","PROJECT_MANAGER","TEAM_MEMBER","READ_ONLY","CLIENT"]),
  projectId: z.string().cuid().optional(),  // for CLIENT role — scope to project
