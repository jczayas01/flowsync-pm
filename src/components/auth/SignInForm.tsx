  ...
  return (
    <div>
      ...
      <p style={{ fontSize:11.5, color:'rgba(255,255,255,.38)', lineHeight:1.6,
        ...
        {t('oauthConsent')}{' '}
        <a href="/legal/terms" target="_blank" rel="noopener" style={{ color:'rgba(255,255,255,.55)' }}>{t('Terms')}</a>
        {' '}{t('and')}{' '}
        <a href="/legal/privacy" target="_blank" rel="noopener" style={{ color:'rgba(255,255,255,.55)' }}>{t('Privacy Policy')}</a>.
      </p>
