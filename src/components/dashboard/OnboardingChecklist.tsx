...
export function OnboardingChecklist({
  ...
  const items: ChecklistItem[] = [
    {
      id:    "workspace",
      label: oc("workspace_label"),
      desc:  oc("workspace_desc"),
      href:  "/settings/workspace",
      cta:   oc("workspace_cta"),
      icon:  "🏢",
      done:  true, // Always done — they created the workspace
    },
    {
      id:    "project",
      label: oc("project_label"),
      desc:  oc("project_desc"),
      href:  "/projects",
      cta:   oc("project_cta"),
      icon:  "📁",
      done:  projectCount > 0,
    ...
    {
      id:    "template",
      label: oc("template_label"),
      desc:  oc("template_desc"),
      href:  "/templates",
      cta:   oc("template_cta"),
      icon:  "📦",
      done:  hasTemplate,
