...
const FEATURES = [
  ...
  { icon:"🔒", title:"Enterprise security & RBAC", color:"#FEF2F2", tag:"Enterprise", tagColor:"#DC2626",
    desc:"8 role levels, 67 permissions, TOTP 2FA, SCIM provisioning, Azure AD SSO, IP allowlisting, and a full audit log ready for HIPAA reviews." },
...
const PLANS = [
  ...
  { name:"Business", price:79, ea:47, color:"var(--text)",
    ...
    features:["Everything in Pro","M365 deep integration","Portfolio & program hierarchy","Azure AD SSO + SCIM","HIPAA audit log","Up to 10 seats"],
    missing:[],
...
const FAQS = [
  ...
  { q:"How deep is the Microsoft 365 integration?",
    a:"FlowSync PM connects via the Graph API and actively monitors your mailbox and calendar. Emails related to a project are auto-tagged. Teams meetings are logged as communications. Planner syncs bidirectionally. This is a native integration — not a Zapier connector." },
  { q:"Is it suitable for HIPAA-regulated environments?",
    a:"Yes. The platform includes a 47-action audit log, consent tracking, document watermarking, and role-based data controls. We sign BAAs for Business and Enterprise plans. Pre-built templates for EHR implementations and HIPAA compliance programs are included." },
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"center"}}>
            ...
            <div>
              ...
              <p style={{fontSize:17,lineHeight:1.7,color:"rgba(255,255,255,.55)",marginBottom:36,maxWidth:480}}>
                Waterfall, Agile, and Scrum in one platform. Built-in M365 integration, EVM budget tracking, HIPAA-ready audit logs, and AI-generated status reports.
              </p>
              {!joined?(
      ...
      <section style={{padding:"96px 0"}}>
        <div style={{maxWidth:1180,margin:"0 auto",padding:"0 24px"}}>
          <div style={{fontSize:11,fontWeight:600,letterSpacing:".12em",textTransform:"uppercase",
            ...
            Why teams switch to FlowSync PM
          </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:40,marginBottom:48}}>
            <div>
              ...
              <p style={{fontSize:13,color:"rgba(255,255,255,.35)",lineHeight:1.65,maxWidth:240,margin:"0 0 12px"}}>
                Enterprise project management for PMOs, healthcare IT, and multi-project organizations.
              </p>
            ...
            {[
              ...
              { title:"Solutions",links:["PMO & Enterprise","Healthcare IT","Consultants","IT & Cloud"] },
