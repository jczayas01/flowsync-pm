...
const METHODOLOGIES = [
  {
    ...
    desc: 'Best for projects with defined scope, fixed budgets, and regulatory requirements. Common in healthcare IT, construction, and ERP deployments.',
...
const TEMPLATES = [
  {
    ...
    desc: '36-week Waterfall · 5 phases · HIPAA checkpoints',
  ...
  },
  {
    ...
    desc: '20-week Agile · FHIR · WCAG 2.1',
    methodology: 'AGILE',
    color: '#1B6CA8',
  },
]
...
export function OnboardingWizard({ userId, userName, userEmail = '' }: {
  ...
  async function finish() {
    ...
    try {
      ...
      const { data: ws } = await wsRes.json()
          ...
          {step === 'workspace' && (
            <>
              ...
              <div style={{ marginBottom:16 }}>
                ...
                <input
                  type="text"
                  placeholder="e.g. Sistema de Salud Menonita"
          ...
          {step === 'project' && (
            <>
              ...
              <div style={{ marginBottom:12 }}>
                ...
                <input
                  type="text"
                  placeholder="e.g. EHR System Modernization 2026"
              ...
              <div style={{ display:'flex', gap:8 }}>
                ...
                >
                  {loading ? (
                    ...
                    form.invites.some(i => i.email.trim()) ? 'Launch FlowSync PM →' : 'Skip & launch →'
                  )}
                </button>
              </div>
            </>
